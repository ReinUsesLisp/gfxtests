...
public:
    ...
    void createFramebufferResources()
    {
        ...
        dk::ImageDescriptor descriptor;
        {
            ...
            view.setFormat(DkImageFormat_R32_Float);
        ...
        for (unsigned i = 0; i < NumFramebuffers; i ++)
        {
            ...
            cmdbuf.bindRenderTargets(nullptr, &rt);
            cmdbuf.setScissors(0, { { 0, 0, 1280, 720 } });
            cmdbuf.clearDepthStencil(true, 0.0f, false, 0);
            cmdbuf.setScissors(0, { { 32, 32, 512, 512 } });
            cmdbuf.clearDepthStencil(true, 0.25f, false, 0);
            cmdbuf.setScissors(0, { { 512+32, 32, 512, 512 } });
            cmdbuf.clearDepthStencil(true, 0.50f, false, 0);
